		...
		<div class="card right-profile-card" style="border: none;">
			<div class="card-body p-5" id="my-message-sibal">
				...
				<div class="d-flex pb-5" id="pet-info-container">
					...
					<div class="pet-info-title">${member.user_nick }님의 반려동물</div>
				...
				<div class="flex-fill col-md-auto pet-work rounded shadow-myinfo" id="map" style="width: 100%; background-color: rgb(249, 249, 249);">
					...
					<div class="pet-work-title" style="z-index: 600; position: absolute;">반려동물 산책로</div>
			...
			<div class="user-statisticData-box">
				<div class="user-statisticData-header">
					<p class="user-sign-txt">${member.user_nick }님은 포펫츠와 ${data.userJoin }일 함께해주셨어요!</p>
				</div>
			</div>
