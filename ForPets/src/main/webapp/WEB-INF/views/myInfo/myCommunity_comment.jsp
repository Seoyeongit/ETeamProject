...
<div class="d-md-flex align-items-center justify-content-between mt-5">
	<div class="d-flex flex-column">
		...
		<div class="p-0">
			<c:set var="id" value="${myD.d_num}" />
			<div class="text-black-50">'${postInMyDat[id].c_title}'에서  ${myD.d_date}에 작성</div>
		</div>
	</div>
	...
	<div class="job-right my-4 flex-shrink-0">
		...
		<a class="btn d-block w-100 d-sm-inline-block btn-light" href="${pageContext.request.contextPath}/viewcommunityboard/${postInMyDat[id].c_code}">더보기</a>
	</div>
